...
from sweets.serializers. FullOrderSerializer import FullOrderSerializer
from sweets.repositories.FullOrderRepository import FullOrderRepository

repository = FullOrderRepository()
